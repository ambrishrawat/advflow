...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Make csv files for train and test set of CIFAR10')
    parser.add_argument('--savepath', type=str, default='/u/ambrish/nparrays', help='location to save numpy arrays')
    args = parser.parse_args()

    work_dir = args.savepath
